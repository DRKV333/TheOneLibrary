...
namespace TheOneLibrary.Utility
{
	public static partial class Utility
	{
		...
		public static string AsPower(this long value, bool perSecond = false) => value.ToSI()
			+ (!string.IsNullOrEmpty(EnergyStorage.EnergyUnitPerSecond) && perSecond ? EnergyStorage.EnergyUnitPerSecond :
			(perSecond ? EnergyStorage.EnergyUnit : EnergyStorage.EnergyUnit + "/s"));
	}
}