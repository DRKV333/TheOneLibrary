...
namespace TheOneLibrary.Utility
{
	...
	public static partial class Utility
	{
		...
		public static void DrawMouseText()
		{
			...
			ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, Main.fontMouseText, MouseText, new Vector2(posX, posY), colorMouseText ?? Color.White, 0f, Vector2.Zero, Vector2.One);
		...
		public static void AlignRight(this UIElement element, float offset = 0f)
		{
			element.HAlign = 1;
			element.Left.Pixels -= offset;
		}

		public static void AlignBottom(this UIElement element, float offset = 0f)
		{
			element.VAlign = 1;
		...
		{
			Dictionary<string, ModHotKey> hotkeys = typeof(ModLoader).GetFieldValue<Dictionary<string, ModHotKey>>("modHotKeys");
		...
		public static void UnloadNullableTypes(this Mod mod)
		{
			foreach (Type type in mod.Code.GetTypes())
			{
				...
				{
					if (!type.IsValueType && info.HasAttribute<NullAttribute>()) info.SetValue(null, null);
				}
